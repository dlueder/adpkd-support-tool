...
class scaleDialog(QDialog):
    def __init__(self, scaling, parent=None, width=0, height=0):
        ...
        self.doneBtn = QPushButton('Ergebnis erzeugen')
        self.doneBtn.clicked.connect(self.setGen)
        layout.addRow(self.doneBtn)

        self.quitBtn = QPushButton('Abbrechen')
        self.quitBtn.clicked.connect(self.closeIt)
        layout.addRow(self.quitBtn)
